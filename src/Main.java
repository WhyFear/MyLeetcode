...
public class Main {
    public static void main(String[] args) {
        ...
        int[] temp = new int[]{2147483647,2147483647,-2147483647,-2147483647,-2147483647,2147483647};
...
//        root.right.right = new TreeNode(1);
        ...
        ReversePairs fuck = new ReversePairs();
//        fuck.solveSudoku(board);
        Scanner in = new Scanner(System.in);
        System.out.println(fuck.reversePairs(temp));
